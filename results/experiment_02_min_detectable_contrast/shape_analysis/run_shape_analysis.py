...
def main() -> None:
    ...
    save_line_plot(grouped, "detection_probability", "Вероятность обнаружения", "shape_analysis_detection_probability_vs_delta_t_by_shape.png")
    ...
    save_heatmap(grouped, "iou_mean", "Средний IoU по форме и Delta T", "shape_analysis_iou_heatmap_shape_delta_t.png")
    save_heatmap(
        grouped,
        "detection_probability",
        "Вероятность обнаружения по форме и Delta T",
        "shape_analysis_detection_probability_heatmap_shape_delta_t.png",
    )
